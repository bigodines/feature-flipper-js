...
Please do not rely on the API.js, if you intend to use feature-flipper-js in your projects, use feature_flippers.js itself
at least until I remove this warning and update the documentation :) great things are coming.
